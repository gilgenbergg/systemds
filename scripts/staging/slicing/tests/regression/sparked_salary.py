...
splits = df_transform_fin.randomSplit([0.8, 0.2])
train_df = splits[0]
test_df = splits[1]
...
if enumerator == "join":
    ...
    sparked_union_slicer.process(all_features, predictions, f_l2, sparkContext, debug=True, alpha=4, k=k, w=0.5, loss_type=0,
                                 enumerator="union")
